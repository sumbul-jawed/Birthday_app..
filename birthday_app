...
if menu == "🎈 Home":
    st.markdown("""
        <h1 style='text-align: center; font-size: 60px; color: #ff8000; text-shadow: 2px 2px #ff0000; '>🎉 Happy Birthday Umar 🎂</h1>
        <h2 style='text-align: center; color: #063970;'>From <span style='background-color: yellow; padding: 4px; border-radius: 5px;'>Jiya Jawed</span></h2>
